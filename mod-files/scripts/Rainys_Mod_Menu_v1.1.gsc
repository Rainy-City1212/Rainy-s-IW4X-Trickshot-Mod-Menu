...
createMenuHud()
{
    ...
    self.menuHudPageLabel = self createMenuTextFont("^6:: MAIN MENU", self.menuX + 23, self.menuY + 52, 0.72, "smallfixed", 9999);
...
updateMenuHud()
{
    ...
    {
        self.menuHudPageLabel.color = (0.72, 0.52, 1.00);
        self.menuHudPageLabel set_text("^6:: " + self getMenuPageLabel());
    }
    botCombatStatus = "^5ON";
    botCombatPlain = "ON";
    chatStatus = "^5OFF";
